...
using System.IO;
using System.Linq;
using JsonCompare.DiffMatchPatch;
...
namespace JsonCompare
{
	public class JsonDiffPatch
	{
		...
		{
			var objectHash = _options.ObjectHash;
		...
		/// <exception cref="InvalidDataException">Thrown if the patch document is invalid</exception>
